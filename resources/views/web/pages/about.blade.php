...
<div class="row">
<div class="col-lg-12">
<img src="{{ asset('frontend') }}/images/about.jpg" alt="" class="img-fluid w-100">
</div>
</div>
...
<div class="row">
    <div class="col-lg-3 col-md-6">
        <div class="about-widget mb-4 mb-lg-0">
            <img src="{{ asset('frontend') }}/images/news/news-1.jpg" alt="" class="img-fluid">
            <h4 class="mt-3">Hill ward</h4>
        </div>
    </div>
    <div class="col-lg-3 col-md-6">
        <div class="about-widget mb-4 mb-lg-0">
            <img src="{{ asset('frontend') }}/images/news/news-2.jpg" alt="" class="img-fluid">
            <h4 class="mt-3">Awesome ride</h4>
        </div>
    </div>
    <div class="col-lg-3 col-md-6">
        <div class="about-widget mb-4 mb-lg-0">
            <img src="{{ asset('frontend') }}/images/news/news-3.jpg" alt="" class="img-fluid">
            <h4 class="mt-3">Newyork</h4>
        </div>
    </div>
    <div class="col-lg-3 col-md-6">
        <div class="about-widget mb-4 mb-lg-0">
            <img src="{{ asset('frontend') }}/images/news/news-4.jpg" alt="" class="img-fluid">
